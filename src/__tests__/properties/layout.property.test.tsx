...
vi.mock('next-intl', () => ({
  useTranslations: () => (key: string) => {
    const translations: Record<string, string> = {
      ...
      'buttons.close': 'Close',
      'footer.copyright': '© {year} FreePDF · piscis.live — Free forever.',
...
describe('Layout Property Tests', () => {
   ...
   * SHALL contain the brand name "FreePDF" in the header or title area.
   */
  describe('Property 2: Brand Consistency', () => {
    it('Header component displays FreePDF brand name for all locales', () => {
      fc.assert(
        fc.property(
          ...
          (locale) => {
            ...
            expect(brandElement.textContent).toBe('FreePDF');
    ...
    it('Footer component displays FreePDF brand name for all locales', () => {
      fc.assert(
        fc.property(
          fc.constantFrom(...locales),
          (locale) => {
      ...
      fc.assert(
        fc.property(
          ...
          (locale) => {
            ...
            expect(headerBrandText).toBe('FreePDF');
      ...
      fc.assert(
        fc.property(
          ...
          (invalidLocale) => {
            ...
            localStorage.setItem('freepdf-language-preference', invalidLocale);
